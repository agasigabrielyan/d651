...
class DetailDirectionOrderTable extends Entity\DataManager
{
    /**
    ...
    {
        return 'rs_detail_direction_order';
    }
    ...
    public static function getMap()
    {
        return [
            ...
            new Entity\TextField('ORDER_NUMBER'),
            new Entity\DatetimeField('ORDER_DATE'),
