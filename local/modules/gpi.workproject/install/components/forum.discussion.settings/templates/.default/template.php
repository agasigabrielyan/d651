...
<div class="entity-settings">
    ...
    <input type="hidden" name="FORUM_ID" value="<?=$arResult['FORUM']['ID']?>">

    <legend>
        <label for="TITLE">Название</label>
        <input type="text" name="TITLE" value="<?=$arResult['FORUM']['TITLE']?>">
    </legend>
    ...
    <legend>
        ...
        $APPLICATION->IncludeComponent(
            ...
            "",
            [
                'TABLE_NAME' => 'Gpi\Workproject\Orm\ForumUserPermissionTable',
                'MODULES_LIST' => [
                    'gpi.workproject'
                ],
                'REF_COLUMN_NAME' => 'FORUM_ID',
                'COLUMN_VALUE' => $arResult['FORUM']['ID'],
                'RULLS_VALUES' => [
                    'X' => 'Полный доступ',
                    'W' => 'Изменение',
                    'R' => 'Чтение',
