 ...
 <div class="<?=$arResult['GRID_ID']?> item local-docs">

     <div class="item-title position-relative">
         <img src="<?=$this->GetFolder().'/img/file.svg'?>">
         ...
         <div class="poisk-container" style="margin-right: 70px">
             ...
             <input type="text" value="<?=$arParams['orders_like']?>" onchange="findOrders(this)"  class="finder">
         </div>
 ...
 <script>
     window.orders_editor = new CoolEditor({
         component : 'rs:activity.directions.item.local.rulls.preview',
