        ...
        foreach ($this->arParams['COLUMNS'] as $key => $column){
            ...
            switch ($column['TYPE']){
                case 'number':
                    $this->arParams['COLUMNS'][$key]['HTML'] = "
                        <legend>
                            ...
                            <input class='field ui-ctl ui-ctl-textbox ui-ctl-inline' $required type='number' value='{$elementData[$column['CODE']]}' name='{$column['CODE']}'>
                        </legend>
                    ";
                    break;
                ...
                case 'user':
                    ...
                    $this->arParams['COLUMNS'][$key]['HTML'].="
                    <script>
                        var renderPlace = document.querySelector('input[name={$column['CODE']}]');
                        ...
                        var tagSelector = new BX.UI.EntitySelector.TagSelector(arFields);
